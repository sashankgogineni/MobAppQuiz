...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS parent1_table(USERNAME VARCHAR PRIMARY KEY,NAME VARCHAR,PASSWORD VARCHAR);");
        ...
        */
        ...
        try {
            ...
            if ( c==null || c.getCount() == 0) {
                db.execSQL("INSERT INTO admin_table VALUES('"+"admin"+"','"+"Admin"+"','"+"password"+"');");
                db.execSQL("INSERT INTO admin_table VALUES('"+"jakefromatl@gmail.com"+"','"+"Jacob Evans"+"','"+"12345"+"');");

            }
            db.execSQL("INSERT INTO admin_table VALUES('"+"admin@domain.com"+"','"+"Admin"+"','"+"password"+"');");
            db.execSQL("INSERT INTO admin_table VALUES('"+"teacher@domain.com"+"','"+"Professor"+"','"+"password"+"');");
            ...
            public void onClick(View view) {
                ...
                if (!enteredAdminNameString.equals("") && !enteredAdminPasswordString.equals("")) {
                    try {
                        ...
                        c = db.rawQuery("SELECT * FROM parent1_table WHERE USERNAME='" +
                                enteredAdminNameString + "' AND PASSWORD='" + enteredAdminPasswordString + "'", null);
                        if (c != null && c.getCount() != 0) {
                            if (c.moveToFirst()){
                                do {
                            ...
                            Intent in = new Intent(getApplicationContext(), Parents.class);
                            f=1;
                            l.setString("NAME",namestr);
                            l.setbool("Loggedin",true);
                            l.setbool("Admin",false);
